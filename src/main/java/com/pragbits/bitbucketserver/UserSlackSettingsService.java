...
public class UserSlackSettingsService implements SlackUserSettingsService {
    ...
    public UserSlackSettingsService(PluginSettingsFactory pluginSettingsFactory, PermissionValidationService validationService) {
        this.validationService = validationService;
        this.pluginSettings = pluginSettingsFactory.createSettingsForKey(PluginMetadata.getPluginKey() + ":users:");
    }

    @Nonnull
    @Override
    public SlackSettings getSlackSettings(@Nonnull ApplicationUser user) {
    ...
    @Nonnull
    @Override
    public SlackSettings setSlackSettings(@Nonnull ApplicationUser user, @Nonnull SlackSettings settings) {
        Map<String, String> data = serialize(checkNotNull(settings, "settings"));
        pluginSettings.put(Integer.toString(user.getId()), data);
